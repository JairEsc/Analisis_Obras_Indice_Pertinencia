...
rasters_list_names[7]='Distancia a localidades con bajo acceso a agua entubada o drenaje sanitario'
rasters_list_names=rasters_list_names[c(1:7,9)]
rasters_list_names[[9]]="Percepción infraestructura vial"##Caso por default
