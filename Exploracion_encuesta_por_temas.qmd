...
regionalizacion=read_sf("../../Reutilizables/regiones/Regiones_FINAL.shp") |> st_transform(st_crs("EPSG:4326")) |> st_as_sf()
...
leaflet() |> addTiles() |> 
  ...
  addPolygons(data=regionalizacion ,fillColor = "#D4C19C",fillOpacity = 0.15,color = "white",opacity = 0.9,stroke = 2,group = 'Regionalizacion') |>
