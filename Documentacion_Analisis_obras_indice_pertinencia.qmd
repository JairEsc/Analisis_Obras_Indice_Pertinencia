...
rasters_full=c(rasters[c(1:8)],rasters_agua[1:2],rasters_drenaje[1:2],rasters_Espacios_publicos[[1]],rasters_salud[[1]],rasters_educacion[[1]])
rasters_list_names_full=c(rasters_list_names[c(1:7,10)],
...
#| message: false
library(sf)
source("codigos/leer_obras_sipdus_carretera_y_separar_por_tipo_geometria.R")
```
...
-   <div>
    ...
    9.  Percepción Infraestructura Vial
